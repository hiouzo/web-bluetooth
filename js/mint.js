...
!function (t, e) {
    ...
    return function (t) {
        ...
        var i = n(58), r = n(53), a = n(1), s = n(54), o = n(57), l = n(52), u = n(81), c = n(8), d = n(84), f = n(82),
            h = n(83), p = n(70), m = n(85), v = n(78), g = n(55), y = n(75), b = n(67), x = n(51), w = n(7), _ = n(80),
            T = n(79), C = n(76), S = n(6), E = n(74), $ = n(86), M = n(61), k = n(68), V = n(62), F = n(65), A = n(56),
            R = n(59), I = n(60), P = n(71), D = n(92), N = (n.n(D), "2.2.1"), O = function (t) {
                ...
                resetSwipeStatus: function () {
                    ...
                    if (this.dragging) {
                        var e, n = t.changedTouches ? t.changedTouches[0] : t, i = n.pageY - this.start.y,
                            r = this.offsetLeft = n.pageX - this.start.x;
            ...
            methods: {
                open: function () {
                    ...
                    if ("time" === this.type) e = t.map(function (t) {
                        ...
                        var i = this.getTrueValue(t[0]), r = this.getTrueValue(t[1]), a = this.getTrueValue(t[2]),
                            s = this.getMonthEndDay(i, r);
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.default = {
            ...
            mounted: function () {
                ...
                for (var n = "", i = Math.PI * (3 + Math.max(["lt", "t", "rt", "r", "rb", "b", "lb", "l"].indexOf(this.direction), 0)) / 4, r = 0; r < this.slotChildren.length; r++) {
                    var a = (Math.PI - 2 * t.offset) / (t.slotChildren.length - 1) * r + t.offset + i,
                        s = (Math.cos(a) * t.radius).toFixed(2), o = (Math.sin(a) * t.radius).toFixed(2),
                        l = ".expand .palette-button-" + t._uid + "-sub-" + r + "{transform:translate(" + s + "px," + o + "px) rotate(720deg);transition-delay:" + .03 * r + "s}";
            ...
            mounted: function () {
                ...
                n.i(i.a)(e, {
                    start: function () {
                        ...
                        if (!t.disabled) {
                            var n = r.getBoundingClientRect(), i = e.pageX - n.left - s.thumbStartLeft,
                                a = Math.ceil((t.max - t.min) / t.step),
                                o = s.thumbStartLeft + i - (s.thumbStartLeft + i) % (n.width / a), l = o / n.width;
            ...
            methods: {
                swipeItemCreated: function () {
                    ...
                    if (!this.noDrag) {
                        ...
                        var r = this.$children[this.index - 1], a = this.$children[this.index],
                    ...
                    if (!this.noDrag) {
                        ...
                        var i = e.currentLeft - e.startLeft, r = e.currentTopAbsolute - e.startTopAbsolute,
                            a = Math.abs(i), s = Math.abs(r);
                    ...
                    if (!this.noDrag) {
                        var t = this.dragState, e = new Date - t.startTime, n = null, i = t.currentLeft - t.startLeft,
                            r = t.currentTop - t.startTop, a = t.pageWidth, s = this.index, o = this.pages.length;
                        if (e < 300) {
        ...
        e.default = {
            name: "mt-tab-container", props: {value: {}, swipeable: Boolean}, data: function () {
                ...
                swipeLeaveTransition: function (t) {
                    ...
                    var e = this;
                    if (this.dragging) {
                        var n, i = t.changedTouches ? t.changedTouches[0] : t, r = i.pageY - this.start.y,
                            s = i.pageX - this.start.x, o = Math.abs(r), l = Math.abs(s);
        ...
        if (!r.a.prototype.$isServer) {
            ...
            var u = {trident: "-ms-", gecko: "-moz-", webkit: "-webkit-", presto: "-o-"}[s], c = {
                    ...
                    webkit: "Webkit",
                    presto: "O"
                }[s], d = document.createElement("div"), f = c + "Perspective", h = c + "Transform", p = u + "transform",
                m = c + "Transition", v = u + "transition", g = c.toLowerCase() + "TransitionEnd";
        ...
        (function (e, i) {
            !function (e, n) {
                ...
                var X = z, Z = 0, q = void 0, G = void 0, U = function (t, e) {
                    ...
                    }, Q = "undefined" != typeof window ? window : void 0, K = Q || {},
                    ...
                    nt = new Array(1e3), it = void 0;
                it = tt ? o() : J ? u() : et ? c() : void 0 === Q ? h() : d();
                var rt = Math.random().toString(36).substring(16), at = void 0, st = 1, ot = 2, lt = new V, ut = new V,
                    ct = 0;
        ...
        !function (e, n) {
            ...
            var i = function (n) {
                var i = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                    r = "2" === n.version.split(".")[0],
                    a = "data:img/jpg;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXs7Oxc9QatAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==",
                    s = {
